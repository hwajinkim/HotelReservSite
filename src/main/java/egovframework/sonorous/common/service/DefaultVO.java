...
public class DefaultVO implements Serializable {
	...
	/** 검색체크인날짜 */
	private String searchCheckIn = "";
	
	/** 검색체크아웃날짜 */
	private String searchCheckOut = "";
	...
	public String getSearchCheckIn() {
		return searchCheckIn;
	}

	public void setSearchCheckIn(String searchCheckIn) {
		this.searchCheckIn = searchCheckIn;
	}

	public String getSearchCheckOut() {
		return searchCheckOut;
	}

	public void setSearchCheckOut(String searchCheckOut) {
	...
	public void setSearchPeople(String searchPeople) {
