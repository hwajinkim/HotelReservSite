...
@Repository("sonorousDAO")
public class SonorousDAO extends EgovAbstractDAO {
	...
	public String insertRoom(RoomVO vo) throws Exception {
		return (String) insert("sonorousDAO.insertRoom", vo);
	}
	...
	/*public void updateSample(SonorousVO vo) throws Exception {
		update("sonorousDAO.updateSample", vo);
	}*/
	...
	/*public void deleteSample(SonorousVO vo) throws Exception {
		delete("sonorousDAO.deleteSample", vo);
	}*/
	 ...
	 * @exception Exception
	 */
	public RoomVO selectRoom(int roomId) throws Exception {
		return (RoomVO) select("sonorousDAO.selectRoom", roomId);
	}
	...
	/*public List<?> selectSampleList(SampleDefaultVO searchVO) throws Exception {
		return list("sonorousDAO.selectSampleList", searchVO);
	}*/
	...
	/*public int selectSampleListTotCnt(SampleDefaultVO searchVO) {
		return (Integer) select("sonorousDAO.selectSampleListTotCnt", searchVO);
	}*/
