...
/**
 * @Class Name : SonorousService.java
 * @Description : SonorousService Class
...
public interface RoomService {
	 ...
	 * @exception Exception
	 */
	void deleteImageAll(int roomId) throws Exception;
	 ...
	 * @exception Exception
	 */
	void deleteImage(int roomImageId) throws Exception;
	 ...
	 * @exception Exception
	 */
	Map selectRoom(int roomId) throws Exception;
	 ...
	 * @exception Exception
	 */
	List<?> selectImage(int roomId) throws Exception;
