...
<div class="container">
	<form name="insertForm" id="insertForm" method="post">
		...
		<input type="hidden" id="mId" name="mId" value="${LOGIN_USER.mId }"/>
		<input type="hidden" id="rsvPrice" name="rsvPrice" value="${roomInfo.roomPrice*diffDays*-1}"/>
		<h3>예약 정보</h3>
		<div id="content_pop">
	    	<table style="">
				...
				<tbody>
					<tr>
		    			<th>예약자명</th>
		    			<td colspan="3"><input type="text" name="kName" value="${ LOGIN_USER.kName}"></td>
		    		</tr>
		    		<tr>
		    			<th>객실명</th>
		    		...
		    		<tr>
		    			<th>최종결제가격</th>
		    			<td colspan="3"><c:out value="${roomInfo.roomPrice*diffDays*-1}" /></td>
		    		</tr>
		    		<tr>
		    			<th>추가요청사항</th>
